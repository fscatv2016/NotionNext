...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, 与我一起加入的网络探索之旅。在这里，我们不仅发现和分享宝贵的网络资源，包括前沿技术、实用工具和创意灵感，还一起勇敢地探索未知的数字领域。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ChenYan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://chenyan.live', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, 工具, 资源, 科技, 视频, 图片, 搞笑', // 网站关键词 英文逗号隔开
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-JNE24HB5G7', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
